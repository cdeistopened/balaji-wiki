---
name: "Parallel Society Precedents"
description: "Historical cases of parallel systems outcompeting or reforming existing ones. Surface when someone asks about examples of parallel societies, exit vs voice, building alternatives, or historical precedents for the network state concept."
type: framework
domain: network-state
episodes:
  - 02-history-as-trajectory/09-one-commandment.md
  - 04-decentralization-recentralization/07-towards-recentralized-center.md
...
> "You have in Christianity, again and again these people coming and saying, 'we don't want the Catholic Church, this institution, let's just every person can read the Bible for himself and know the truth'... and within twenty years or fifty years, they realize that when you let every person read the Bible for themselves you get 100 different interpretations. So eventually someone comes and says 'No, these are the correct interpretations' and you get the Lutheran church."
> -- Yuval Harari, quoted in The Network State, Ch 4.7
...
> "The new boss is not the same as the old boss, anymore than Apple was the same as BlackBerry, Amazon was the same as Barnes and Noble, or America was the same as Britain."
...
1. An existing system develops pathologies
2. Internal reform fails (incumbents block change)
3. Someone builds a parallel system that works better
4. The parallel system creates competitive pressure
5. The existing system either reforms under pressure or collapses
