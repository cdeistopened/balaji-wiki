---
name: "The Five Truth Types"
description: "Reference for Balaji's taxonomy of truth — scientific, technical, political, economic, and cryptographic — with verification methods for each. Surface when someone asks about types of truth, how to verify claims, scientific vs political truth, or epistemology."
type: framework
domain: epistemology
episodes:
  - 02-history-as-trajectory/03-political-power-and-technological-truth.md
...
> "A timestamp is more powerful than Macron" — because cryptographic truths don't depend on institutional credibility.
> -- Balaji Srinivasan, The Network State, Ch 2.3 (paraphrased)

### The Hierarchy

Balaji implicitly ranks these by durability:

1. **Cryptographic** (mathematically provable, unfakeable)
2. **Scientific** (reproducibly demonstrable)
3. **Technical** (verifiable by outcome)
4. **Economic** (market-verified but volatile)
5. **Political** (consensus-dependent, changeable)
...
> "According to the Chinese government of 2021, the number of COVID deaths in China from mid 2020-2022 was zero. According to the San Francisco government of 2021, the crime rate in SF was declining. According to the US establishment of 2021, the inflation of the dollar was transitory."
