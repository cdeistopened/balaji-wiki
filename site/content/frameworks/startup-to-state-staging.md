---
name: "Startup to State: The Staging Model"
description: "Reference for the progression from startup society to network state, with the startup funding round analogy. Surface when someone asks about community stages, scaling a startup society, or the path to network state."
type: framework
...
> "An impressive enough network archipelago can achieve diplomatic recognition from an existing government, thereby becoming a true network state."
> -- Balaji Srinivasan, The Network State, Ch 5.3
...
1. **Startup Society**: Satoshi's whitepaper and the cypherpunk mailing list (2008-2009)
2. **Network Union**: The Bitcoin community coordinating defense against attacks, funding development (2010-2015)
3. **Network Archipelago**: Bitcoin ATMs, mining farms, crypto-friendly jurisdictions physically hosting infrastructure (2015-2020)
4. **Network State**: El Salvador recognizing Bitcoin as legal tender (2021)
