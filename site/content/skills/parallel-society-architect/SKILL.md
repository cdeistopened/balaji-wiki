...
1. What specific institution, system, or norm are you trying to change?
2. What exactly is broken about it? (Be specific: regulatory capture, misaligned incentives, structural decay, ideological capture, technical obsolescence)
3. Who benefits from the current system staying the way it is? (Identify the incumbents)
4. Have reform efforts been tried before? What happened?
5. What would "fixed" look like? Describe the ideal end state.
...
1. **Visibility**: How will people in the old system see that the new one works? (Metrics, testimonials, migration data, census)
2. **Migration path**: How easy is it for someone to switch from the old system to the new one? (The easier, the more pressure)
3. **Proof of concept scale**: What's the minimum viable size where the parallel system is clearly better? (10 people? 1,000? 100,000?)
4. **The "Deng Xiaoping visit"**: How could a reform-minded leader from the old system come, see the parallel system working, and import the model?
