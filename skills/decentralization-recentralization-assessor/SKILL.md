...
1. What system, institution, or industry are you evaluating?
2. What is its current governance structure? (Centralized hierarchy, decentralized network, hybrid, other)
3. What's prompting this analysis? (A specific event, trend, strategic decision)
4. What's your stake? (Insider trying to adapt, outsider trying to disrupt, investor trying to predict, citizen trying to understand)
...
- Opportunity: Build a parallel system (see `parallel-society-architect`). The incumbents' reassertion of control will drive people toward alternatives.
...
- Reference: `references/frameworks/decentralization-forces-2026.md`
